  ...
  return (
    <section className="section" id="testimonials">
      ...
      >
        ...
        <motion.span
          className="whitespace-nowrap self-end text-red-orange"
          style={{
            x: transformBottom,
          }}
        >
      ...
      <div className="container">
        ...
        <div className="flex gap-4 mt-6 lg:mt-10">
          <button
            className="border border-stone-400 size-11 inline-flex items-center justify-center rounded-full hover:bg-red-orange hover:text-white hover:border-red-orange transition-all duration-300"
